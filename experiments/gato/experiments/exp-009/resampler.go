...
//
// Included for completeness. The mock TTS in EXP-009 outputs at 48 kHz directly,
// so the resampler is not used in the main pipeline. It would be needed when
// integrating a real TTS service that outputs at 24 kHz.
type LinearResampler struct {
	prev    int16 // last sample of the previous chunk, for boundary interpolation
	hasPrev bool
}
